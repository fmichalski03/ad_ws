...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Xsens_message_member_array[1] = {
  {
    ...
    offsetof(ad_ws_interfaces::msg::Xsens, structure_needs_at_least_one_member),  // bytes offset in struct
