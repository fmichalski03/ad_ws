...
#include "ad_ws_interfaces/msg/detail/signal__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const ad_ws_interfaces::msg::Signal & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  ad_ws_interfaces::msg::Signal & ros_message)
{
  // Member: value
  cdr >> ros_message.value;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ad_ws_interfaces::msg::Signal;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const ad_ws_interfaces::msg::Signal *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ad_ws_interfaces::msg::Signal *>(
    untyped_ros_message);
...
{
  return &ad_ws_interfaces::msg::typesupport_fastrtps_cpp::_Signal__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ad_ws_interfaces, msg, Signal)() {
  return &ad_ws_interfaces::msg::typesupport_fastrtps_cpp::_Signal__handle;
}
