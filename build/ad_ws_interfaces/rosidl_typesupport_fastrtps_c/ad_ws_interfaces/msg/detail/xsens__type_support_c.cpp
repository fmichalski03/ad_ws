...
#include "ad_ws_interfaces/msg/detail/xsens__rosidl_typesupport_fastrtps_c.h"
...
#include "ad_ws_interfaces/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
...
using _Xsens__ros_msg_type = ad_ws_interfaces__msg__Xsens;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ad_ws_interfaces
size_t get_serialized_size_ad_ws_interfaces__msg__Xsens(
  const void * untyped_ros_message,
...
static uint32_t _Xsens__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_ad_ws_interfaces__msg__Xsens(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ad_ws_interfaces
size_t max_serialized_size_ad_ws_interfaces__msg__Xsens(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _Xsens__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ad_ws_interfaces__msg__Xsens(
...
static message_type_support_callbacks_t __callbacks_Xsens = {
...
static rosidl_message_type_support_t _Xsens__type_support = {
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ad_ws_interfaces, msg, Xsens)() {
  return &_Xsens__type_support;
}
