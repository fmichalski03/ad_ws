...
static const _Signal_type_support_symbol_names_t _Signal_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ad_ws_interfaces, msg, Signal)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ad_ws_interfaces, msg, Signal)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, ad_ws_interfaces, msg, Signal)() {
  return &::ad_ws_interfaces::msg::rosidl_typesupport_c::Signal_message_type_support_handle;
}
